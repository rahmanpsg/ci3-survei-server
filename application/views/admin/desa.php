...
<body>
                    ...
                    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                        <div class="mdc-card">
                            <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-10">
                                <h1 class="mdc-typography--headline2">Data Desa</h1>
                            </div>
                            <div class="toolbar">
                                            ...
                                            <form id="form">
                                                <div class="template-demo">
                                                    ...
                                                    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-10-desktop" style="margin-bottom: 20px;">
                                                        <div class="mdc-text-field mdc-text-field--outlined">
                                                            <input class="mdc-text-field__input" name="desa" oninvalid="this.setCustomValidity('Desa harus diisi')" oninput="setCustomValidity('')" autocomplete="off" required>
                                                            <div class="mdc-notched-outline">
                                                                <div class="mdc-notched-outline__leading"></div>
                                                                <div class="mdc-notched-outline__notch">
                                                                    <label class="mdc-floating-label">Desa</label>
                                                                </div>
                                                                <div class="mdc-notched-outline__trailing"></div>
                                                            </div>
                                                        </div>
    ...
    <script>
        ...
        function tambahData() {
            $form.trigger('reset');
            $modal.modal('toggle')
            $modalLabel.text('Form Tambah Desa')
        ...
        window.aksiEvents = {
            'click .ubah': function(e, value, row, index) {
                $form.trigger('reset')
                $modalLabel.text('Form Ubah Desa')
                $modal.modal('toggle')

                $('input[name=id]').val(row.id)
                $('input[name=desa]').val(row.desa)
