...
<body>
                    ...
                    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                        <div class="mdc-card">
                            <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-10">
                                <h1 class="mdc-typography--headline2">Data Bidang</h1>
                            </div>
                            <div class="toolbar">
                                                ...
                                                <div class="template-demo">
                                                    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-2-desktop">
                                                        <div class="mdc-text-field mdc-text-field--outlined">
                                                            <input type="text" class="mdc-text-field__input" name="id" readonly>
                                                            <div class="mdc-notched-outline mdc-notched-outline--notched">
                                                                <div class="mdc-notched-outline__leading"></div>
                                                                <div class="mdc-notched-outline__notch">
                                                                    <label class="mdc-floating-label mdc-floating-label--float-above">ID</label>
                                                                </div>
                                                    ...
                                                    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-10-desktop" style="margin-bottom: 20px;">
                                                        <div class="mdc-text-field mdc-text-field--outlined">
                                                            <input class="mdc-text-field__input" name="bidang" oninvalid="this.setCustomValidity('Bidang harus diisi')" oninput="setCustomValidity('')" autocomplete="off" required>
                                                            <div class="mdc-notched-outline">
                                                                <div class="mdc-notched-outline__leading"></div>
                                                                <div class="mdc-notched-outline__notch">
                                                                    <label class="mdc-floating-label">Bidang</label>
                                                                </div>
                                                                <div class="mdc-notched-outline__trailing"></div>
                                                            </div>
                                                        </div>
    ...
    <script>
        ...
        function tambahData() {
            $form.trigger('reset');
            $modal.modal('toggle')
            $modalLabel.text('Form Tambah Bidang')
        ...
        window.aksiEvents = {
            'click .ubah': function(e, value, row, index) {
                $form.trigger('reset')
                $modalLabel.text('Form Ubah Bidang')
                $modal.modal('toggle')

                $('input[name=id]').val(row.id)
                $('input[name=bidang]').val(row.bidang)
